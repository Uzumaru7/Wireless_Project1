...
class Map8 extends StatelessWidget {
  static const route_path = '/map8';
  const Map8({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FlutterMap(
        options: MapOptions(
          center: latLng.LatLng(13.7351619, 100.5822178),
          zoom: 17.0,
        ),
        layers: [
          TileLayerOptions(
          ...
          MarkerLayerOptions(
            markers: [
              Marker(
                width: 45.0,
                height: 45.0,
                point: latLng.LatLng(13.7351619, 100.5822178),
