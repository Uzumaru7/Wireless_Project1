...
class Review6 extends StatelessWidget {
  static const route_path = '/review6';
  const Review6({Key? key}) : super(key: key);
  @override
              ...
              child: Column(
                children: <Widget>[
                  ClipRRect(
                    ...
                    child: Image.asset('assets/images/MustangBlu.jpg',
                        width: 400, height: 500, fit: BoxFit.fill),
                  ),
                  ListTile(
