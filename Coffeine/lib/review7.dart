...
class Review7 extends StatelessWidget {
  static const route_path = '/review7';
  const Review7({Key? key}) : super(key: key);
  @override
              ...
              child: Column(
                children: <Widget>[
                  ClipRRect(
                    ...
                    child: Image.asset('assets/images/RootsLasalle.jpg',
                        width: 480, height: 300, fit: BoxFit.fill),
                  ),
                  ListTile(
