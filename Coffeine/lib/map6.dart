...
class Map6 extends StatelessWidget {
  static const route_path = '/map6';
  const Map6({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FlutterMap(
        options: MapOptions(
          center: latLng.LatLng(13.7390154, 100.5149919),
          zoom: 17.0,
        ),
        layers: [
          TileLayerOptions(
          ...
          MarkerLayerOptions(
            markers: [
              Marker(
                width: 45.0,
                height: 45.0,
                point: latLng.LatLng(13.7390154, 100.5149919),
