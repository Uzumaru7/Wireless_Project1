  ...
  static Weather _convert(json) {
    ...
    if (main == 'Thunderstorm') {
      return Weather(
        city: city,
        degrees: degrees,
        description: city+' Looks like a storm\'s brewing!',
      ...
      return Weather(
        city: city,
        degrees: degrees,
        description: city+' Looks like rain.',
      ...
      return Weather(
        city: city,
        degrees: degrees,
        description: city+' Looks like more rain.',
      ...
      return Weather(
        city: city,
        degrees: degrees,
        description: city+' Wrap up, it\'s going to snow!',
      ...
      return Weather(
        city: city,
        degrees: degrees,
        description: city+' Looks like scattered clouds today.',
